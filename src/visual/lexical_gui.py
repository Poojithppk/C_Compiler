...
from compiler.lexer import VisualLexicalAnalyzer
from utils.tokens import Token, TokenType, LexicalError
...
class LexicalAnalysisGUI:
    ...
    def load_sample(self):
        ...
        sample_code = '''// Sample Program in Our Custom Language
var x: int = 42;
